...
func main() {
	...
	log.Fatal(r.RunTLS(":8080", "/home/admin/conf/web/test.example.com/ssl/kys.kurbandefteri.com.crt", "/home/admin/conf/web/test.example.com/ssl/kys.kurbandefteri.com.key"))
}
